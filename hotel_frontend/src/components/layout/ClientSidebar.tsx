...
const ClientSidebar = () => {
    ...
    return (
        <>
            {/* Mobile Top Header */}
            <header className="md:hidden fixed top-0 left-0 right-0 h-16 flex items-center justify-center bg-card/50 backdrop-blur-xl border-b border-white/5 z-50">
                <Link to="/" className="transition-transform active:scale-95">
                    <img src="/logo.png" alt="Logo" className="h-16 w-auto object-contain" />
                </Link>
            </header>

            <aside className="fixed z-40 right-0 top-0 h-screen w-24 hidden md:flex flex-col py-8 items-center bg-card border-l">
