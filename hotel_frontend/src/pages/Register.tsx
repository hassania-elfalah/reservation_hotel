...
const Register = () => {
    ...
    const onSubmit = async (v: any) => {
        ...
        try {
            ...
            // AuthContext handles success toast and token storage
            navigate('/');
        } catch (e: any) {
    ...
    return (
        <AuthLayout
            ...
            subtitle="Commencez votre expérience avec nous."
            image="https://images.unsplash.com/photo-1571896349842-33c89424de2d?q=80&w=2080"
            sideTitle="Rejoignez l'élite du voyage."
            sideSubtitle="Débloquez des avantages exclusifs dès maintenant."
        >
